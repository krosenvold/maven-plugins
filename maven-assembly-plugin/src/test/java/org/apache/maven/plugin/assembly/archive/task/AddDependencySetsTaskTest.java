    ...
    extends TestCase
{
        ...
        throws ArchiveCreationException, InvalidAssemblerConfigurationException
    {
        ...
        final Set<Artifact> result = task.resolveDependencyArtifacts( dependencySet,  Collections.singleton( artifactMock.getArtifact() ) );
        ...
        throws ArchiveCreationException, InvalidAssemblerConfigurationException
    {
        ...
        final Set<Artifact> result = task.resolveDependencyArtifacts( dependencySet,  artifacts );
